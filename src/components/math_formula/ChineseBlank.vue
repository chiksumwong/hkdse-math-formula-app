<template>
  <Page class="page">
    <ActionBar class="action-bar" title="中文空白版">
    ...
    data() {
      return {
        chapters: [{
            ...
            contents: [{
              index: "誤差",
              imagePath: "~/images/hkdse_math_formula/chinese_blank/2/2.png"
            }]
          },
          {
            title: "單元三 百分比",
            contents: [{
                index: "I.	 百分變化",
                imagePath: "~/images/hkdse_math_formula/chinese_blank/3/3.1.png"
              },
              {
                index: "II.	 利潤及虧蝕",
                imagePath: "~/images/hkdse_math_formula/chinese_blank/3/3.2.png"
              },
              {
                index: "III.	 折扣",
                imagePath: "~/images/hkdse_math_formula/chinese_blank/3/3.3.png"
              },
              {
                index: "IV.	 單利息和複利息",
                imagePath: "~/images/hkdse_math_formula/chinese_blank/3/3.4.png"
              },
              {
                index: "V.	 增長及貶值",
                imagePath: "~/images/hkdse_math_formula/chinese_blank/3/3.5.png"
              },
            ]
          },
          {
          ...
          },
          {
            ...
            contents: [{
              index: "率、比和變分",
              imagePath: "~/images/hkdse_math_formula/chinese_blank/12/12.png"
          ...
          },
          {
            ...
            contents: [{
              index: "變換對函數的影響",
              imagePath: "~/images/hkdse_math_formula/chinese_blank/19/19.png"
          ...
          },
          {
            ...
            contents: [{
              index: "圓的方程",
              imagePath: "~/images/hkdse_math_formula/chinese_blank/20/20.png"
          ...
          },
          {
            ...
            contents: [{
              index: "排列與組合",
              imagePath: "~/images/hkdse_math_formula/chinese_blank/21/21.png"
            }, ]
          },
          {
            title: "單元二十二 概率",
